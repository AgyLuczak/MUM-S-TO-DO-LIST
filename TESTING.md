...
| **Password input** - empty | The password is a required field, so should not submit with no value | Tried to submit the form with no value entered | Tooltip lets user know this value is required | PASS |
...
| `My List` |
|   |   |   |   |  |
| **Add '+' button** in the heading | When the user clicks this button they should be taken to the Add New Item Page| Clicked the button | Redirected to the Add New Item Page | Pass |
...
| `Categories` |
|   |   |   |   |  |
| **Add '+' button** in the heading | When the user clicks this button they should be taken to the Add Category Page| Clicked the button | Redirected to the Add Category Page | PASS |
